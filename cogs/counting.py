...
class Counting(commands.Cog):
    ...
    async def set_failRole(self, ctx, role: discord.Role):
        ...
        await ctx.respond("The fail role is set to {0}".format(role.mention), ephemeral=True)
    ...
    async def set_counting_channel(self, ctx, channel: discord.TextChannel):   
        ...
        await ctx.respond("Counting channel set to {0}".format(channel.mention), ephemeral=True)
