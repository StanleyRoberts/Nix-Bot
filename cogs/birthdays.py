...
class Birthdays(commands.Cog):
    ...
    async def set_birthday(self, ctx,
        ...
        db.single_SQL("INSERT INTO Birthdays (GuildID, UserID, Birthdate) VALUES (%s, %s, %s) ON CONFLICT (GuildID, UserID) DO UPDATE SET Birthdate=%s",
    ...
    async def daily_bday(self):
        ...
        val = db.single_SQL("SELECT BirthdayChannelID, string_agg(UserID::varchar, \' \') FROM Birthdays INNER JOIN"\
