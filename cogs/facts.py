...
class Facts(commands.Cog):
    ...
    async def set_fact_channel(self, ctx, channel: discord.TextChannel):
        ...
        await ctx.respond("<:NixDrinking:929938768016863293> Facts channel set to {0}".format(channel.mention), ephemeral=True)
    ...
    async def toggle_facts(self, ctx):
        ...
        await ctx.respond("<:NixNoEmotion:929947568547442718> Stopping daily facts", ephemeral=True)
