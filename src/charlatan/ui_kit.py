...
class CharlatanLobby(discord.ui.View):
    ...
    async def join_callback(self, _: discord.ui.Button[CharlatanLobby], interaction: discord.Interaction) -> None:
    ...
    async def rules_callback(self, _: discord.ui.Button[CharlatanLobby], interaction: discord.Interaction) -> None:
        await interaction.response.send_message(
            ephemeral=True,
    ...
    async def wordlist_callback(self, _: discord.ui.Button[CharlatanLobby], interaction: discord.Interaction) -> None:
    ...
    async def start_callback(self, _: discord.ui.Button[CharlatanLobby], interaction: discord.Interaction) -> None:
    ...
    async def leave_callback(self, _: discord.ui.Button[CharlatanLobby], interaction: discord.Interaction) -> None:
        if interaction.user:
...
class CharlatanView(discord.ui.View):
    ...
    async def start_game(self, _: discord.ui.Button[CharlatanView], interaction: discord.Interaction) -> None:
